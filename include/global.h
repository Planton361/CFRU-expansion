...
enum DifficultyMode
{
	DIFFICULTY_MODE_NORMAL = OPTIONS_NORMAL_DIFFICULTY,
	DIFFICULTY_MODE_EASY = OPTIONS_EASY_DIFFICULTY,
	DIFFICULTY_MODE_HARD = OPTIONS_HARD_DIFFICULTY,
	DIFFICULTY_MODE_EXPERT = OPTIONS_EXPERT_DIFFICULTY,
};

enum TrainerLevelScalingMode
{
	TRAINER_LEVEL_SCALING_OFF,
