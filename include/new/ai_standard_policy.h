...
enum StandardPolicyEffectFamily
{
	...
	/* Appended Ironmon families; all accepted Standard numeric values stay put. */
	STANDARD_EFFECT_DAMAGE = 19,
	STANDARD_EFFECT_MAJOR_STATUS = 20,
	STANDARD_EFFECT_TOXIC = 21,
	STANDARD_EFFECT_LEECH_SEED = 22,
	STANDARD_EFFECT_YAWN = 23,
	STANDARD_EFFECT_RECOVERY = 24,
	STANDARD_EFFECT_PROTECT = 25,
	STANDARD_EFFECT_FIELD = 26,
	STANDARD_EFFECT_SETUP = 27,
	STANDARD_EFFECT_RESIDUAL_COMBO = 28,
	STANDARD_EFFECT_UNSUPPORTED = 29,
};
