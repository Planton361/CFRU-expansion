...
enum
{
	STANDARD_ERROR = STANDARD_POLICY_ERROR,
	STANDARD_NO_ADMITTED_ACTION = STANDARD_POLICY_NO_ADMITTED_ACTION,
	STANDARD_INVALID_CANDIDATE = STANDARD_POLICY_INVALID_CANDIDATE,
};
